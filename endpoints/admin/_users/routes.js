...
const create_user_v2 = require('./_v/_v2/create_user');
const edit_user_v2 = require('./_v/_v2/edit_user');
...
api.post({path: '/users/create'}, core.verifytoken, create_user_v2);
api.post({path: '/users/edit'}, core.verifytoken, edit_user_v2);
